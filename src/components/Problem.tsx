        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {problems.map((problem, index) => (
              <div 
                key={index}
                className="flex items-start gap-6 p-8 rounded-2xl bg-card border border-border shadow-sm hover:shadow-elegant transition-all duration-300"
              >
          ...
          {/* Solution Teaser */}
          <div className="text-center bg-gradient-hero rounded-3xl p-12 text-foreground">
